              ...
              <table class="tables">
                ...
                <tbody>
                  ...
                  <tr id="favoriteproducts<?php echo $tcval['id'];?>">
                    ...
                    <td><a href="<?php echo base_url().'products/view/'.$tcval['pslug'];?>">
                    <img src="<?php echo base_url(); ?>uploads/product/thumbnails/<?php echo $tcval['image_name'];?>" alt="<?php echo $tcval['productcode'];?>" width="100"></a> </td>
                    <td><?php echo date('d-m-Y h:i A',strtotime($tcval['created_datetime']));?> </td>
                    <td>
                    <a href="<?php echo base_url().'products/view/'.$tcval['pslug'];?>" class="btn btn-outline-dark">View</a>
                    &nbsp;&nbsp;
