							...
							<div class="grid grid-three">
								...
								<div class="grid-item four col-sm-12 col-md-6">
									<div class="sin-product style-three">
										...
										<div class="mid-wrapper">
											<h5 class="pro-title"><a href="<?php echo base_url(); ?>products">Real Diamonds Collections </a></h5>
										</div>										
									</div>
								</div>
								<!-- /.col-xl-6 -->
								...
								<div class="grid-item five col-sm-12 col-md-6">
									<div class="sin-product style-three">
										...
										<div class="mid-wrapper">
											<h5 class="pro-title"><a href="<?php echo base_url(); ?>products">Platinum Collections</a></h5>
										</div>										
									</div>
								</div>
								<!-- /.col-xl-6 -->
