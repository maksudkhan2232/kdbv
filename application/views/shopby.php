...
<title>Our Products |  KD Bhindi Jewellers</title>
  ...
  <section class="breadcrumb-area">
    <div class="container-fluid custom-container">
      <div class="row">
        <div class="col-xl-12">
          <div class="bc-inner">
            <p> <a href="<?php echo base_url(); ?>">Home  |</a> <a href="<?php echo base_url().'shopby/'.$type; ?>"><?php echo $type;?> |</a> <?php echo $SubType;?> </p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="order-2 order-lg-1 col-lg-3 col-xl-3">
          <div class=" shop-sidebar">
            ...
            <?php  if(!empty($GroupByCategoryDetails)) { ?>
            <div class="sidebar-widget category-widget">
              <h6>Collections / Categories</h6>
              <ul>
                <?php foreach ($GroupByCategoryDetails as $ckey => $cvalue) {
            ...
            <div class="sidebar-widget category-widget">
              ...
              <form>
                <?php if(!empty($GenderDetails)){ 
					foreach ($GenderDetails as $gkey => $gvalue) { 
					  $gselect='';
                      if($type=='gender'){
                        if($gvalue['name']==$filedvalue){
                          $gselect=' checked';
                        }
                      }
                      if($type=='search'){
                        if(strpos($gvalue['name'], $filedvalue) !== false){
                            $gselect=' checked';
                        }
                      }
				?>
                    <div class="form-group">
                        <input type="checkbox" class="gender" id="gender<?php echo ucwords($gvalue['id']);?>" name="gender[]" value="<?php echo $gvalue['name'];?>" onClick="return OnProductPage();" <?php echo $gselect;?> >
            ...
            <div class="sidebar-widget category-widget">
              ...
              <form>
                <?php if(!empty($GroupByCollectionDetails)){ 
					foreach ($GroupByCollectionDetails as $gkey => $gvalue) { 
					    $cselect='';
                        if($type=='collections'){
                          if($gvalue['id']==$filedvalue){
                            $cselect=' checked';
                          }
                        }
                        if($type=='search'){
				...
				?>
                		<div class="form-group">
                  <input type="checkbox" name="collection[]" class="collection" id="collection<?php echo ucwords($gvalue['collectiontype']);?>" onClick="return OnProductPage();" value="<?php echo $gvalue['collectiontype'];?>" <?php echo $cselect;?> >
            ...
            <div class="sidebar-widget product-widget">
              ...
              <?php  foreach($TrendingDetails as $tckey=>$tcval) {  ?>
              <div class="wid-pro">
                <div class="sp-img"> <img src="<?php echo base_url(); ?>uploads/product/thumbnails/<?php echo $tcval['image_name'];?>" alt="<?php echo $tcval['productcode'];?>" width="94"> </div>
                <div class="small-pro-details">
                  ...
                  <span><?php echo $tcval['collectionshortname'];?> /</span> <span><?php echo $tcval['categoryname'];?></span>
                  <div class="rating"> <a href="<?php echo base_url().'products/view/'.$tcval['slug'];?>">View Details</a> </div>
                </div>
              </div>
              <?php  } ?>
            </div>
            <div class="sidebar-widget product-widget">
              ...
              <div class="singleProduct-slider owl-carousel owl-theme">
                ...
                <div class="sin-instagram"> <img src="<?php echo  base_url(); ?>uploads/collections/<?php echo $cvalue['image'];?>" alt="<?php echo ucwords($cvalue['name']);?>">
            ...
            <div class="sidebar-widget product-widget">
              <h6>Trending Products</h6>
              <div class="wid-pro">
                <div class="sp-img"> <a href="<?php echo base_url().'shopby/trending/';?>"> <img src="<?php echo base_url().'uploads/trending/'.$TrendingCollectionSideImage['image']; ?>" alt="">
                  <div class="pb-info">
          ...
          <div class="shop-content shop-four-grid">
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="row" id="ProductDetailsShow">
                  ...
                  <div class="col-sm-6 col-xl-3 popularityset" data-id="<?php echo $pvalue['id'];?>">
                    <div class="sin-product style-two">
                      <div class="pro-img"> <img src="<?php echo base_url(); ?>uploads/product/thumbnails/<?php echo $pvalue['image_name'];?>" alt="<?php echo $pvalue['productcode'];?>"> </div>
                      <?php  if (strpos($pvalue['highlight'], 'NEW ARRIVAL') !== false) { ?>
                      <span class="new-tag"> NEW </span>
                      <?php } ?>
                      <?php  if (strpos($pvalue['highlight'], 'TRENDING COLLECTIONS') !== false) { ?>
                    	  <span class="new-tag"> Trending </span>
                      <?php } ?>
                      <div class="mid-wrapper">
                        <h5 class="pro-title"> <a href="<?php echo base_url().'products/view/'.$pvalue['slug'];?>"><?php echo $pvalue['productcode'];?></a> </h5>
                      ...
                      <div class="icon-wrapper">
                        ...
                        <div class="add-to-cart"> <a href="javascript:void(0);"  onclick="return addtocart(<?php echo $pvalue['id'];?>);">add to cart</a> <a href="<?php echo base_url().'products/view/'.$pvalue['slug'];?>" type="button" class="btn-outline-dark">View</a></div>
                      </div>
                    </div>
                  </div>
                  <?php 
            	...
            	<img src="<?php echo base_url(); ?>assest/frontend/media/images/no.png" alt="KD Bhindi Junagadh">
            </figure>
