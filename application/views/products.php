...
<title>Products |  KD Bhindi Jewellers</title>
  ...
  <section class="breadcrumb-area">
    <div class="container-fluid custom-container">
      <div class="row">
        <div class="col-xl-12">
          <div class="bc-inner">
            <p><a href="<?php echo base_url(); ?>">Home  |</a> <a href="<?php echo base_url(); ?>collections">Collections  |</a> Gold</p>
          </div>
        </div>
        <!-- /.col-xl-12 -->
      </div>
        ...
        <div class="order-2 order-lg-1 col-lg-3 col-xl-3">
          <div class=" shop-sidebar">
            ...
            <div class="sidebar-widget category-widget">
              ...
              <ul>
                <li><a href="#">Earrings</a> <span>(19)</span></li>
            ...
            <div class="sidebar-widget product-widget">
              ...
              <div class="wid-pro">
                <div class="sp-img"> <img src="<?php echo  base_url(); ?>assest/frontend/media/images/product/sb1.jpg" alt=""> </div>
                <div class="small-pro-details">
                  <h5 class="title"><a href="#">The Felicidad Oval Bangle</a></h5>
                  <span>Gold / Bracelet</span>
                  <div class="rating"> <a href="javascript:void(0);">View Details</a> </div>
                </div>
              </div>
              <div class="wid-pro">
                <div class="sp-img"> <img src="<?php echo  base_url(); ?>assest/frontend/media/images/product/sb1.jpg" alt=""> </div>
            ...
            <div class="sidebar-widget product-widget">
              ...
              <div class="singleProduct-slider owl-carousel owl-theme">
                <div class="sin-instagram"> <img src="<?php echo  base_url(); ?>assest/frontend/media/images/products/01.png" alt="">
                  <div class="hover-text"> <a href="#"> <span>Gold Jewellery</span> </a> </div>
                </div>
                <div class="sin-instagram"> <img src="<?php echo  base_url(); ?>assest/frontend/media/images/products/02.png" alt="">
                  <div class="hover-text"> <a href="#"> <span>Silver Jewellery</span> </a> </div>
                </div>
                <div class="sin-instagram"> <img src="<?php echo  base_url(); ?>assest/frontend/media/images/products/03.png" alt="">
                  <div class="hover-text"> <a href="#"> <span>Real Diamond Jewellery</span> </a> </div>
                </div>
                <div class="sin-instagram"> <img src="<?php echo  base_url(); ?>assest/frontend/media/images/products/04.png" alt="">
                  <div class="hover-text"> <a href="#"> <span>Platinum Jewellery</span> </a> </div>
                </div>
              </div>
            </div>
            <div class="sidebar-widget banner-wid">
              <div class="img"> <img src="<?php echo  base_url(); ?>assest/frontend/media/images/banner/sb1.jpg" alt=""> </div>
            </div>
          </div>
        </div>
        <!-- /.col-xl-3 -->
        <div class="order-1 order-lg-2 col-lg-9 col-xl-9">
          <div class="shop-sorting-area row">
            <div class="col-4 col-sm-4 col-md-6">
              <?php /*?><ul class="nav nav-tabs shop-btn" id="myTab" role="tablist">
									<li class="nav-item ">
          ...
          <div class="shop-content shop-four-grid">
            ...
            <!-- /.tab-content -->
            <div class="load-more-wrapper"> <a href="#" class="btn-two">Load More</a> </div>
