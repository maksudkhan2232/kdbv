      ...
      <div class="row">
        ...
        <div class="col-xl-3">
          <div class="account-details">
            ...
            <div class="list-group"> <a href="<?php echo base_url(); ?>customer/" class="list-group-item list-group-item-action active"> Orders </a> <a href="<?php echo base_url(); ?>customer/favoriteproducts/" class="list-group-item list-group-item-action">Favorite Product</a> <a href="<?php echo base_url(); ?>customer/profile/" class="list-group-item list-group-item-action">Profile</a> <a href="<?php echo base_url(); ?>customer/logout" class="list-group-item list-group-item-action">LogOut</a> </div>
          </div>
          <!-- /.cart-subtotal -->
        </div>
        <!-- /.col-xl-3 -->
          ...
          <div class="account-table">
            ...
            <table class="tables">
              ...
              <tbody>
                  ...
                  if(!empty($GetOrderDetails)){
                    foreach($GetOrderDetails as $tckey=>$tcval){ ?>
                      <tr>
                        ...
                        <td><?php echo $tcval['TotalProducts'];?> </td>
                        <td>
                ...
                ?>
                <tr>
                  <td colspan="5">You haven't any order yet.</td>
                </tr>
                <?php
                  }
                ?>
