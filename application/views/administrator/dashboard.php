                  ...
                  <div class="card">
                    <div class="card-body text-left">
                      ...
                      <div class="form-group">
                        ...
                        <?php echo '<div class="text-danger">'.form_error('name').'</div>' ?> </div>
                      <hr>
                  ...
                  <table id="order-listing" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo ucwords($value['ShippingCity']);?></td>
                        <td><a href="<?php echo base_url()."administrator/order/view/".$value['OrderID'];?>" target="_blank" class="btn btn-primary">View</a></td>
                      </tr>
                      <?php 
      ...
      <div class="content-wrapper">
        <div class="row">
          ...
          <div class="col-lg-4 mb-5">
            <div class="block">
              <div class="list-group border-bottom"> <a href="javascript:void(0);" class="list-group-item" style="background-color:#fc5c65;color:#fff"><?php echo $v['category']; ?></a>
