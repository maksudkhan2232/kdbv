                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <input type="file" accept="image/x-png,image" id="image" data-num="1" name="image" class="file-upload-default" >
                        ...
                        $img=base_url().'uploads/collections/'.$image;
                        ...
                        <div style="color:#000099;font-size:14px;text-align:center;">
                          ...
                          Image Size  = Width : <font color="#FF0000">800 px</font> &nbsp;&nbsp;&nbsp;&nbsp; Height : <font color="#FF0000">800 px</font><br>
                      ...
                      <table id="order-listing" class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="<?php echo base_url()."uploads/collections/".$val['image']; ?>" target="_blank">

                              <img src="<?php echo base_url()."uploads/collections/".$val['image']; ?>" class="img-thumbnail">
