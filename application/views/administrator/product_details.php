                    ...
                    <form action="<?php echo $action; ?>" id="myForm" enctype="multipart/form-data" method="post" accept-charset="utf-8" onSubmit="return validate()">
                      ...
                      <div class="row">
                        <div class="col-md-6">                   
                            ...
                            <?php echo '<div class="text-danger">'.form_error('collectiontype').'</div>' ?>
                          </div>
                        </div>
                        <div class="col-md-6">                                       
                          <div class="form-group">
                            ...
                            <?php echo '<div class="text-danger">'.form_error('categoryid').'</div>' ?>
                          </div>
                        </div>
                      </div>                   
                      <div class="row">
                        ...
                        <div class="col-md-6">                                       
                           <div class="form-group">
                             ...
                             <input type="text" class="form-control" id="productcode" name="productcode" value="<?php echo $productcode; ?>" placeholder="Enter Product Code">
                              <?php echo '<div class="text-danger">'.form_error('productcode').'</div>' ?>
                            </div>
                        </div>
                        <div class="col-md-6">                   
                          <div class="form-group">
                        ...
                        <div class="col-md-6">  
                          ...
                          <div class="col-md-12 mb-5">
                            <div class="form-group">  
                              ...
                              ?>                     
                              <div class="text-danger" id="cate_error" style="display: none;"><p>Please Select Atleast One Gender.</p></div>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">  
                          ...
                          <div class="col-md-12 mb-5">
                            <div class="form-group">  
                              ...
                              ?>                     
                              <div class="text-danger" id="cate_error" style="display: none;"><p>Please Select Atleast One Highlights.</p></div>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-12"> 
                          ...
                          <div class="form-group mb-5">
                            <div class="row">
                              ...
                              <div style="color:#000099;font-size:14px;"> &nbsp; &nbsp; &nbsp;Image Size  = Width : 550 px &nbsp;&nbsp;&nbsp;&nbsp; Height : 600 px</div>
                            </div>
                          </div>
                        </div>
                      </div>
                              ...
                              foreach ($image as $key => $value) { ?>
                                <div class="col-md-3" id="productimage<?php echo $value['id']; ?>">
                                  <div class="img-wrapper text-center">
                                    <img src="<?php echo  base_url().'uploads/product/thumbnails/'.$value['image_name']; ?>" class="img-thumbnail">
                     ...
                     <br>
                      <div class="form-group">
                        ...
                        <?php echo '<div class="text-danger">'.form_error('description').'</div>' ?>
                      </div>
                      <hr>                  
                      ...
                      <div class="row"  id="extrafields">
                        <div class="col-md-6">                   
                          <div class="form-group">
                            ...
                            <?php echo '<div class="text-danger">'.form_error('extrafield').'</div>' ?>
                          </div>
                        </div>
                        <div class="col-md-6">                   
                          <div class="form-group">
                            ...
                            <?php echo '<div class="text-danger">'.form_error('extrafieldvalue').'</div>' ?>
                          </div>
                        </div>
                      </div>
                      ...
                      ?>
                            <div class="row" id="ProductExtraFiled<?php echo $value['id']; ?>">
                              ...
                              <div class="col-md-2">                   
                                <div class="form-group">
                                  <br>
                                  <a onClick="check_confirm_extra_delete('<?php echo $value['id']; ?>');" href="javascript:void(0);" class="btn btn-danger mr-2">
                                        <i class="fa fa-trash"></i>
                                  </a>                                   
                                </div>
                              </div>
