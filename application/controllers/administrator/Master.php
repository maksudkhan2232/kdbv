...
class Master extends MY_Controller  {
	        ...
	        if(isset($_FILES['image']['name']) && $_FILES['image']['name']!=""){
...

	            {
...

	            	 {
	            	 	...
	            	 	$this->form_validation->set_message('file_check_edit_subcategory', 'Error : Invaliad Width / Height.');
	...
	{ 		
		...
		$data['viewdata']=$this->Crud_Model->getDatafromtablewhere('gender','1=1','ASC');
	...
	public function file_check_trending($str){
        ...
        if(isset($_FILES['image']['name']) && $_FILES['image']['name']!=""){
            ...
            $this->form_validation->set_message('file_check_trending', 'Please Upload Trending Photo.');
