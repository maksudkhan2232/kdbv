! function(e) {
    ...
    e(window).on("load", (function() {
        e(".preloader").fadeOut(), setTimeout((function() {
    ...
    e(window).on("scroll", (function() {
        var t, a, n, o, i;
        t = e(".sticky-active"), a = "active", n = "will-sticky", o = e(window).scrollTop(), i = t.css("height"), t.parent().css("min-height", i), e(window).scrollTop() > 800 ? (t.parent().addClass(n), o > s ? t.removeClass(a) : t.addClass(a)) : (t.parent().css("min-height", "").removeClass(n), t.removeClass(a)), s = o, e(this).scrollTop() > 500 ? e(".scrollToTop").addClass("show") : e(".scrollToTop").removeClass("show")
    ...
    })), o(".sidemenu-wrapper", ".sideMenuToggler", ".sideMenuCls", "show"), o(".popup-newsletter-active", ".popupNewsletterToggler", ".popup-newsletter-closer", "show"), t = ".popup-search-box", a = ".searchClose", n = "show", e(".searchBoxToggler").on("click", (function(a) {
        ...
        e(this).each((function() {
            ...
            n = Math.floor(c.height() / 2), s = c.attr(t), o = c.attr(a), l = i(e(o).css("padding-top")), r = i(e(o).css("padding-bottom")), "top-half" === s ? (e(o).css("padding-bottom", r + n + "px"), c.css("margin-top", "-" + n + "px")) : "bottom-half" === s && (e(o).css("padding-top", l + n + "px"), c.css("margin-bottom", "-" + n + "px"))
        }))
    };
    e("[data-sec-pos]").length && e("[data-sec-pos]").imagesLoaded((function() {
        ...
        e(this).each((function() {
            ...
            var s = setInterval((function() {
                ...
                i < 10 && (i = "0" + i), l < 10 && (l = "0" + l), r < 10 && (r = "0" + r), c < 10 && (c = "0" + c), o < 0 ? (clearInterval(s), t.addClass("expired"), t.find(".message").css("display", "block")) : (n(".day").html(i), n(".hour").html(l), n(".minute").html(r), n(".seconds").html(c))
            }), 1e3)
        }))
    }, e(".offer-counter").length && e(".offer-counter").countdown(), e("[data-ani-duration]").each((function() {
        ...
        e(a.$slides).find("[data-ani]").removeClass("as-animated"), e(a.$slides[n]).find("[data-ani]").addClass("as-animated")
    ...
    e.fn.buttonAnimation = function() {
        e(this).each((function() {
            var t = e(this).html();
            e(this).html(""), e(this).prepend('<span class="btn-text">' + t + '</span><span class="btn-text-mask">' + t + "</span>")
        }))
