...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item"> <a class="nav-link" href="<?php echo base_url(); ?>administrator/slider"> <i class="fa fa-bullhorn menu-icon"></i> <span class="menu-title">Slider</span> </a> </li>
